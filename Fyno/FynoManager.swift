...
protocol FynoManagerDelegate {
    func reloadCountriesInfo(_ manager: FynoManager)
}

class FynoManager: NSObject {
    static var shared = FynoManager()
    var delegate: FynoManagerDelegate?
    
    var bucketList: [CountryModel] = [] {
        didSet{
            delegate?.reloadCountriesInfo(self)
        }
    }
    
    var showBucketAll: Bool = false {
        didSet{
            if showBucketAll {
                bucketLimit = 999
            }else{
    ...
    var bucketLimit: Int = 3
    
    var bucketListShort: [CountryModel] {
        return Array(bucketList.prefix(bucketLimit))
    }
    
    var showMoreBucket: Bool {
        return bucketList.count > bucketLimit
    }
    
    var moreBucketCount: Int {
        return bucketList.count - bucketLimit
    }
    
    var percentBucketPercent: Float {
        return (Float(bucketList.count) / Float(totalCountriesList.count)) * 100
    }
    
    
    var beenToList: [CountryModel] = [] {
        didSet{
            delegate?.reloadCountriesInfo(self)
        }
    }
    var showBeenToAll: Bool = false {
        didSet{
            if showBeenToAll {
                beenToLimit = 999
            }else{
    ...
    var beenToLimit: Int = 3
    
    var beenToListShort: [CountryModel] {
        return Array(beenToList.prefix(beenToLimit))
    }
    
    var showMoreBeenTo: Bool {
        return beenToList.count > beenToLimit
    }
    
    var moreBeenToCount: Int {
        return beenToList.count - beenToLimit
    }
    
    var totalCountriesList: [CountryModel] = []
    ...
    func reloadData() {
        ...
        for code in NSLocale.isoCountryCodes  {
            ...
            if let name = NSLocale(localeIdentifier: "en_UK").displayName(forKey: NSLocale.Key.identifier, value: id) {
                ...
                countriesData.append(CountryModel(countryTitle: name, flag: flag?.image(), isoCountryCodes: code, coordinates: self.getCoordinatesForCountryCode(countryCode: code)))
            }else{
                //"Country not found for code: \(code)"
            }
        }
        
        totalCountriesList = countriesData
        
    }
    
    func getCountriesForMap() -> [CustomAnnotation] {
        
        var resultList: [CustomAnnotation] = []
        
        bucketList.forEach { item in
            if let coordinates = item.coordinates {
                let anno = CustomAnnotation()
                anno.coordinate = coordinates
                anno.pinImage = item.flag
                anno.visited = true
        ...
        beenToList.forEach { item in
            if !bucketList.contains(where: { item2 in
                return item.isoCountryCodes == item2.isoCountryCodes
            }) {
                if let coordinates = item.coordinates {
                    let anno = CustomAnnotation()
                    anno.coordinate = coordinates
    ...
    func getCoordinatesForCountryCode(countryCode: String) -> CLLocationCoordinate2D? {
...
let countryCoordinates: [String: CLLocationCoordinate2D] = [
    ...
    "AE": CLLocationCoordinate2D(latitude: 23.424076, longitude: 53.847818),
    ...
    "AL": CLLocationCoordinate2D(latitude: 41.153332, longitude: 20.168331),
    ...
    "AR": CLLocationCoordinate2D(latitude: -38.416097, longitude: -63.616672),
    "AS": CLLocationCoordinate2D(latitude: -14.270972, longitude: -170.132217),
    "AT": CLLocationCoordinate2D(latitude: 47.516231, longitude: 14.550072),
    "AU": CLLocationCoordinate2D(latitude: -25.274398, longitude: 133.775136),
    "AW": CLLocationCoordinate2D(latitude: 12.52111, longitude: -69.968338),
    "AZ": CLLocationCoordinate2D(latitude: 40.143105, longitude: 47.576927),
        "BA": CLLocationCoordinate2D(latitude: 43.915886, longitude: 17.679076),
            ...
            "BE": CLLocationCoordinate2D(latitude: 50.503887, longitude: 4.469936),
            "BF": CLLocationCoordinate2D(latitude: 12.238333, longitude: -1.561593),
            "BG": CLLocationCoordinate2D(latitude: 42.733883, longitude: 25.48583),
            ...
            "BR": CLLocationCoordinate2D(latitude: -14.235004, longitude: -51.92528),
            ...
            "CA": CLLocationCoordinate2D(latitude: 56.130366, longitude: -106.346771),
            ...
            "CH": CLLocationCoordinate2D(latitude: 46.818188, longitude: 8.227512),
            ...
            "CL": CLLocationCoordinate2D(latitude: -35.675147, longitude: -71.542969),
            ...
            "CR": CLLocationCoordinate2D(latitude: 9.748917, longitude: -83.753428),
            ...
            "CY": CLLocationCoordinate2D(latitude: 35.126413, longitude: 33.429859),
            "CZ": CLLocationCoordinate2D(latitude: 49.817492, longitude: 15.472962),
            "DE": CLLocationCoordinate2D(latitude: 51.165691, longitude: 10.451526),
            "DJ": CLLocationCoordinate2D(latitude: 11.825138, longitude: 42.590275),
            "DK": CLLocationCoordinate2D(latitude: 56.26392, longitude: 9.501785),
            ...
            "EE": CLLocationCoordinate2D(latitude: 58.595272, longitude: 25.013607),
            "EG": CLLocationCoordinate2D(latitude: 26.820553, longitude: 30.802498),
            ...
            "ES": CLLocationCoordinate2D(latitude: 40.463667, longitude: -3.74922),
            "ET": CLLocationCoordinate2D(latitude: 9.145, longitude: 40.489673),
            "FI": CLLocationCoordinate2D(latitude: 61.92411, longitude: 25.748151),
            ...
            "FR": CLLocationCoordinate2D(latitude: 46.227638, longitude: 2.213749),
            "GA": CLLocationCoordinate2D(latitude: -0.803689, longitude: 11.609444),
            "GB": CLLocationCoordinate2D(latitude: 55.378051, longitude: -3.435973),
            "GD": CLLocationCoordinate2D(latitude: 12.262776, longitude: -61.604171),
            "GE": CLLocationCoordinate2D(latitude: 42.315407, longitude: 43.356892),
            ...
            "GR": CLLocationCoordinate2D(latitude: 39.074208, longitude: 21.824312),
            ...
            "GZ": CLLocationCoordinate2D(latitude: 31.354676, longitude: 34.308825),
            "HK": CLLocationCoordinate2D(latitude: 22.396428, longitude: 114.109497),
            ...
            "HU": CLLocationCoordinate2D(latitude: 47.162494, longitude: 19.503304),
            "ID": CLLocationCoordinate2D(latitude: -0.789275, longitude: 113.921327),
            "IE": CLLocationCoordinate2D(latitude: 53.41291, longitude: -8.24389),
            "IL": CLLocationCoordinate2D(latitude: 31.046051, longitude: 34.851612),
            "IM": CLLocationCoordinate2D(latitude: 54.236107, longitude: -4.548056),
            "IN": CLLocationCoordinate2D(latitude: 20.593684, longitude: 78.96288),
            ...
            "IS": CLLocationCoordinate2D(latitude: 64.963051, longitude: -19.020835),
            "IT": CLLocationCoordinate2D(latitude: 41.87194, longitude: 12.56738),
            ...
            "JP": CLLocationCoordinate2D(latitude: 36.204824, longitude: 138.252924),
            ...
            "KR": CLLocationCoordinate2D(latitude: 35.907757, longitude: 127.766922),
            ...
            "LU": CLLocationCoordinate2D(latitude: 49.815273, longitude: 6.129583),
            "LV": CLLocationCoordinate2D(latitude: 56.879635, longitude: 24.603189),
            ...
            "MD": CLLocationCoordinate2D(latitude: 47.411631, longitude: 28.369885),
            ...
            "MK": CLLocationCoordinate2D(latitude: 41.608635, longitude: 21.745275),
            ...
            "MX": CLLocationCoordinate2D(latitude: 23.634501, longitude: -102.552784),
            "MY": CLLocationCoordinate2D(latitude: 4.210484, longitude: 101.975766),
            ...
            "NL": CLLocationCoordinate2D(latitude: 52.132633, longitude: 5.291266),
            "NO": CLLocationCoordinate2D(latitude: 60.472024, longitude: 8.468946),
            ...
            "NZ": CLLocationCoordinate2D(latitude: -40.900557, longitude: 174.885971),
            ...
            "PL": CLLocationCoordinate2D(latitude: 51.919438, longitude: 19.145136),
            ...
            "PT": CLLocationCoordinate2D(latitude: 39.399872, longitude: -8.224454),
            ...
            "RO": CLLocationCoordinate2D(latitude: 45.943161, longitude: 24.96676),
            "RS": CLLocationCoordinate2D(latitude: 44.016521, longitude: 21.005859),
            "RU": CLLocationCoordinate2D(latitude: 61.52401, longitude: 105.318756),
            ...
            "SE": CLLocationCoordinate2D(latitude: 60.128161, longitude: 18.643501),
            "SG": CLLocationCoordinate2D(latitude: 1.352083, longitude: 103.819836),
            "SH": CLLocationCoordinate2D(latitude: -24.143474, longitude: -10.030696),
            "SI": CLLocationCoordinate2D(latitude: 46.151241, longitude: 14.995463),
            "SJ": CLLocationCoordinate2D(latitude: 77.553604, longitude: 23.670272),
            "SK": CLLocationCoordinate2D(latitude: 48.669026, longitude: 19.699024),
            ...
            "TH": CLLocationCoordinate2D(latitude: 15.870032, longitude: 100.992541),
            ...
            "TR": CLLocationCoordinate2D(latitude: 38.963745, longitude: 35.243322),
            ...
            "TW": CLLocationCoordinate2D(latitude: 23.69781, longitude: 120.960515),
            "TZ": CLLocationCoordinate2D(latitude: -6.369028, longitude: 34.888822),
            "UA": CLLocationCoordinate2D(latitude: 48.379433, longitude: 31.16558),
            "UG": CLLocationCoordinate2D(latitude: 1.373333, longitude: 32.290275),
            "US": CLLocationCoordinate2D(latitude: 37.09024, longitude: -95.712891),
            ...
            "VN": CLLocationCoordinate2D(latitude: 14.058324, longitude: 108.277199),
            ...
            "ZA": CLLocationCoordinate2D(latitude: -30.559482, longitude: 22.937506),
